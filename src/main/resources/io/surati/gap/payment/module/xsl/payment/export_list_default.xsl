      ...
      <div class="card-header">
        ...
        <xsl:if test="sec:hasAccess(.,'EXECUTER_ORDRES_PAIEMENT')">
          <div class="btn-actions-pane-right">
            <div class="row">
              <a href="javascript:void(0)" class="btn-icon btn-wide btn-outline-2x btn btn-outline-focus btn-sm d-flex" ng-click="vm.exportPayments()" ng-class="{{disabled: vm.loadingData}}" ng-if="vm.items.length &gt; 0">
