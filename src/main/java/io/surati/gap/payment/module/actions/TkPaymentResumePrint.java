 ...
 *
 */
public final class TkPaymentResumePrint implements Take {

	private final DataSource source;

	public TkPaymentResumePrint(final DataSource source) {
		this.source = source;
	}
	...
	public Response act(Request req) throws Exception {
		...
		log.info("Impression du bordereau de paiement (%s)", note.internalReference());
